...
void StoreManager::processDataFiles(std::ifstream &inventoryFile, std::ifstream &customerFile, std::ifstream &commandfile){
   myStore = new Store();
...
void StoreManager::FillInventory(std::ifstream &inventoryFile){
...
void StoreManager::FillCustomerData(std::ifstream &customerFile){
...
void StoreManager::ProcessTransactions(std::ifstream &commandfile){
